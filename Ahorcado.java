...
public class Ahorcado extends javax.swing.JFrame {
    ...
    public Ahorcado() {
        ...
        imgs[0] = new ImageIcon(getClass().getResource("/proy/Ima/im1.jpg"));
        imgs[1] = new ImageIcon(getClass().getResource("/proy/Ima/im2.jpg"));
        imgs[2] = new ImageIcon(getClass().getResource("/proy/Ima/im3.jpg"));
        imgs[3] = new ImageIcon(getClass().getResource("/proy/Ima/im4.jpg"));
        imgs[4] = new ImageIcon(getClass().getResource("/proy/Ima/im5.jpg"));
        imgs[5] = new ImageIcon(getClass().getResource("/proy/Ima/im6.jpg"));
        ...
        msgs[0] = "Father".toUpperCase();
        msgs[1] = "Mother".toUpperCase();
        msgs[2] = "Uncle".toUpperCase();
        msgs[3] = "Cousin".toUpperCase();
        msgs[4] = "GrandMother".toUpperCase();
        msgs[5] = "GrandFather".toUpperCase();
        msgs[6] = "Wife".toUpperCase();
        msgs[7] = "Housband".toUpperCase();
        msgs[8] = "Brother".toUpperCase();
        msgs[9] = "House".toUpperCase();
        msgs[10] = "Party".toUpperCase();
        msgs[11] = "Brithday".toUpperCase();
        msgs[12] = "Kitchen".toUpperCase();
        msgs[13] = "Televition".toUpperCase();
        msgs[14] = "Morning".toUpperCase();
        msgs[15] = "Evening".toUpperCase();
        msgs[16] = "Nigth".toUpperCase();
        msgs[17] = "Cat".toUpperCase();
        msgs[18] = "Dog".toUpperCase();
        msgs[19] = "Head".toUpperCase();
        ...
        for (int i = 1; i < 27; i++) {
            if (bt == btns[i]) {
                ...
                if (esta) {
                    ...
                    if (gano) {
                        JOptionPane.showMessageDialog(this, "Haz ganado 10 puntos!");
                        //iniciar();
                        usuario.victoria();
                        Menu abrir=new Menu();
                    ...
                    if (err == 5) {
                        JOptionPane.showMessageDialog(this,"La palabra correcta era:"+msgs[ran]);
                        usuario.perder();
                        Menu abrir=new Menu();
                        abrir.setVisible(true);
                        this.setVisible(false);
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proy/Ima/im1.jpg"))); // NOI18N
